...
class LawfareDaily(base.LawfareArt):
    name = "LawfareDaily"
    souce = "Lawfare"
    daily = True
    # custom_settings = settings
...
class CyberScoopDaily(base.CyberScoopArt):
    name = "CyberScoop"
    daily = True
    # custom_settings = settings
...
class WSJSpiderDaily(base.WSJArt):
...
class SecAffDaily(base.SecAffArt):
...
class WiredDaily(base.WiredArt):
    name = "Wired"
...
class DefenseOneDaily(base.DefenseOneArt):
    name = "Defense One"
...
class ZDNetDaily(base.ZDNetArt):
    name = "ZDNet"
...
class C4ISRNETDaily(base.C4ISRNETArt):
    name = "C4ISRNET"
...
# class InsideCSDaily(base.InsideCSArt):
